...
<img src = "https://res.cloudinary.com/practicaldev/image/fetch/s--tjoJfBuF--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qztmxquclvp62qqae9h1.png" width = "900" height = "350">
...
| Salary                                 | $95K - $106K                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Job Description                        | Mid-level Full-Stack Software Service Engineers that are passionate about software and cloud engineering to build the next-gen data services based on the latest big data and at scale cloud technologies. Collaborate with a Product Owner, Product Manager, and Product Designer to deliver products and core-platform components that support the web services that are performant, secure, and reliable. Define, design, code, test, and deploy services that interact with multiple large scale data systems as well as the production processes around them, such as deployment and health-monitoring. |
| City                                   | Oakville, ON                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Additional skills/ experience required | 1 + years of programming experience in Java or C++ or C object-oriented programming  1+ years developing APIs and REST services experience  1+ years of experience in building Web applications and Web services using Python, HTML5, CSS, JavaScript, TypeScript, jQuery, Angular, React or similar skills  Experience developing products using extreme agile/ pair/mobbed programming in a test-driven development (TDD).                                                                                                                                                                                 |
